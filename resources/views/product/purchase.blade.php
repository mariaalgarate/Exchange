...
@section('content')
    ...
    <div class="container py-5">
        ...
        <form action="{{ route('processPurchase', ['id' => $producto->id]) }}" method="post">
            ...
            <div class="form-group mb-4">
                ...
                <select id="tipo_envio" class="form-select @error('tipo_envio') is-invalid @enderror" name="tipo_envio"
                    ...
                    <div class="shipping-option">
                        ...
                        <label for="GSL">
                            <img src="https://storage.googleapis.com/wp-es-pro-media/2021/10/logo-glswhite.png"
                                alt="GSL" style="background-color: blue">
                        </label>
                    </div>
                </div>
                @error('empresa_paqueteria')
                    <span class="invalid-feedback" role="alert">
                        <strong>{{ $message }}</strong>
                    </span>
                @enderror
            ...
            <div class="form-group mb-4">
                ...
                <input type="text" id="zona_entrega" name="zona_entrega"
                    class="form-control @error('zona_entrega') is-invalid @enderror"
                    placeholder="Calle, número, piso, ciudad, pais" required>
                @error('zona_entrega')
                    <span class="invalid-feedback" role="alert">
                        <strong>{{ $message }}</strong>
                    </span>
    ...
    <script>
        document.addEventListener('DOMContentLoaded', function() {
            const mapa = L.map('mapa-ubicacion').setView([40.4168, -3.7038],
            13); // Madrid, España, como posición inicial
